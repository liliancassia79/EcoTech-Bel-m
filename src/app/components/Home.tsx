...
export default function Home() {
  ...
  type LocationType = "shopping" | "university" | "cooperative";
          ...
          return (
            ...
            >
              <div className="relative">
                <motion.div
                  className={`absolute inset-0 -m-4 bg-gradient-to-r ${typeColors[locationType]} rounded-full opacity-20`}
                  animate={{
                    scale: [1, 1.8, 1],
                    opacity: [0.2, 0, 0.2],
                  }}
                ...
                <div className={`relative bg-gradient-to-br ${typeColors[locationType]} p-3 rounded-xl shadow-xl border-2 border-white`}>
                  <Icon className="w-5 h-5 text-white" />
                </div>

                <div className="absolute top-full mt-3 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-4 min-w-[220px] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  ...
                  <button
                    ...
                    className="mt-3 w-full bg-gradient-to-r from-[var(--eco-amazon)] to-[var(--eco-amazon-dark)] text-white text-xs py-2 px-3 rounded-lg font-semibold hover:shadow-lg transition"
                  >
                    Ver no Mapa
                  </button>
                </div>
